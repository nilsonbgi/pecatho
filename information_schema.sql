...
--
-- Host: localhost:3306
-- Tempo de geração: 31/08/2026 às 12:39
...
--
-- Estrutura stand-in para view `ALL_PLUGINS`
-- (Veja abaixo para a visão atual)
--
DROP VIEW IF EXISTS `ALL_PLUGINS`;
...
--
-- Estrutura stand-in para view `APPLICABLE_ROLES`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `CHARACTER_SETS`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `CHECK_CONSTRAINTS`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `CLIENT_STATISTICS`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `COLLATIONS`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `COLLATION_CHARACTER_SET_APPLICABILITY`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `COLUMNS`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `COLUMN_PRIVILEGES`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `ENABLED_ROLES`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `ENGINES`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `EVENTS`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `FILES`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `GEOMETRY_COLUMNS`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `GLOBAL_STATUS`
-- (Veja abaixo para a visão atual)
--
DROP VIEW IF EXISTS `GLOBAL_STATUS`;
...
--
-- Estrutura stand-in para view `GLOBAL_VARIABLES`
-- (Veja abaixo para a visão atual)
--
DROP VIEW IF EXISTS `GLOBAL_VARIABLES`;
...
--
-- Estrutura stand-in para view `INDEX_STATISTICS`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `INNODB_BUFFER_PAGE`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `INNODB_BUFFER_PAGE_LRU`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `INNODB_BUFFER_POOL_STATS`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `INNODB_CMP`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `INNODB_CMPMEM`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `INNODB_CMPMEM_RESET`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `INNODB_CMP_PER_INDEX`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `INNODB_CMP_PER_INDEX_RESET`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `INNODB_CMP_RESET`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `INNODB_FT_BEING_DELETED`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `INNODB_FT_CONFIG`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `INNODB_FT_DEFAULT_STOPWORD`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `INNODB_FT_DELETED`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `INNODB_FT_INDEX_CACHE`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `INNODB_FT_INDEX_TABLE`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `INNODB_LOCKS`
-- (Veja abaixo para a visão atual)
--
DROP VIEW IF EXISTS `INNODB_LOCKS`;
CREATE TABLE IF NOT EXISTS `INNODB_LOCKS` (
`lock_id` varchar(81)
...
--
-- Estrutura stand-in para view `INNODB_LOCK_WAITS`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `INNODB_METRICS`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `INNODB_MUTEXES`
-- (Veja abaixo para a visão atual)
--
DROP VIEW IF EXISTS `INNODB_MUTEXES`;
CREATE TABLE IF NOT EXISTS `INNODB_MUTEXES` (
`NAME` varchar(4000)
...
--
-- Estrutura stand-in para view `INNODB_SYS_COLUMNS`
-- (Veja abaixo para a visão atual)
--
DROP VIEW IF EXISTS `INNODB_SYS_COLUMNS`;
CREATE TABLE IF NOT EXISTS `INNODB_SYS_COLUMNS` (
...
--
-- Estrutura stand-in para view `INNODB_SYS_DATAFILES`
-- (Veja abaixo para a visão atual)
--
DROP VIEW IF EXISTS `INNODB_SYS_DATAFILES`;
CREATE TABLE IF NOT EXISTS `INNODB_SYS_DATAFILES` (
...
--
-- Estrutura stand-in para view `INNODB_SYS_FIELDS`
-- (Veja abaixo para a visão atual)
--
DROP VIEW IF EXISTS `INNODB_SYS_FIELDS`;
CREATE TABLE IF NOT EXISTS `INNODB_SYS_FIELDS` (
...
--
-- Estrutura stand-in para view `INNODB_SYS_FOREIGN`
-- (Veja abaixo para a visão atual)
--
DROP VIEW IF EXISTS `INNODB_SYS_FOREIGN`;
CREATE TABLE IF NOT EXISTS `INNODB_SYS_FOREIGN` (
`ID` varchar(193)
...
--
-- Estrutura stand-in para view `INNODB_SYS_FOREIGN_COLS`
-- (Veja abaixo para a visão atual)
--
DROP VIEW IF EXISTS `INNODB_SYS_FOREIGN_COLS`;
CREATE TABLE IF NOT EXISTS `INNODB_SYS_FOREIGN_COLS` (
`ID` varchar(193)
...
--
-- Estrutura stand-in para view `INNODB_SYS_INDEXES`
-- (Veja abaixo para a visão atual)
--
DROP VIEW IF EXISTS `INNODB_SYS_INDEXES`;
CREATE TABLE IF NOT EXISTS `INNODB_SYS_INDEXES` (
`INDEX_ID` bigint(21) unsigned
,`NAME` varchar(193)
,`TABLE_ID` bigint(21) unsigned
,`TYPE` int(11)
...
--
-- Estrutura stand-in para view `INNODB_SYS_SEMAPHORE_WAITS`
-- (Veja abaixo para a visão atual)
--
DROP VIEW IF EXISTS `INNODB_SYS_SEMAPHORE_WAITS`;
CREATE TABLE IF NOT EXISTS `INNODB_SYS_SEMAPHORE_WAITS` (
...
--
-- Estrutura stand-in para view `INNODB_SYS_TABLES`
-- (Veja abaixo para a visão atual)
--
DROP VIEW IF EXISTS `INNODB_SYS_TABLES`;
CREATE TABLE IF NOT EXISTS `INNODB_SYS_TABLES` (
`TABLE_ID` bigint(21) unsigned
,`NAME` varchar(655)
,`FLAG` int(11)
,`N_COLS` int(11)
...
--
-- Estrutura stand-in para view `INNODB_SYS_TABLESPACES`
-- (Veja abaixo para a visão atual)
--
DROP VIEW IF EXISTS `INNODB_SYS_TABLESPACES`;
CREATE TABLE IF NOT EXISTS `INNODB_SYS_TABLESPACES` (
`SPACE` int(11) unsigned
,`NAME` varchar(655)
...
--
-- Estrutura stand-in para view `INNODB_SYS_TABLESTATS`
-- (Veja abaixo para a visão atual)
--
DROP VIEW IF EXISTS `INNODB_SYS_TABLESTATS`;
CREATE TABLE IF NOT EXISTS `INNODB_SYS_TABLESTATS` (
`TABLE_ID` bigint(21) unsigned
,`NAME` varchar(193)
...
--
-- Estrutura stand-in para view `INNODB_SYS_VIRTUAL`
-- (Veja abaixo para a visão atual)
--
DROP VIEW IF EXISTS `INNODB_SYS_VIRTUAL`;
CREATE TABLE IF NOT EXISTS `INNODB_SYS_VIRTUAL` (
`TABLE_ID` bigint(21) unsigned
,`POS` int(11) unsigned
...
--
-- Estrutura stand-in para view `INNODB_TABLESPACES_ENCRYPTION`
-- (Veja abaixo para a visão atual)
--
DROP VIEW IF EXISTS `INNODB_TABLESPACES_ENCRYPTION`;
CREATE TABLE IF NOT EXISTS `INNODB_TABLESPACES_ENCRYPTION` (
`SPACE` int(11) unsigned
,`NAME` varchar(655)
...
--
-- Estrutura stand-in para view `INNODB_TABLESPACES_SCRUBBING`
-- (Veja abaixo para a visão atual)
--
DROP VIEW IF EXISTS `INNODB_TABLESPACES_SCRUBBING`;
CREATE TABLE IF NOT EXISTS `INNODB_TABLESPACES_SCRUBBING` (
`SPACE` bigint(21) unsigned
,`NAME` varchar(655)
...
--
-- Estrutura stand-in para view `INNODB_TRX`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `KEYWORDS`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `KEY_CACHES`
-- (Veja abaixo para a visão atual)
--
DROP VIEW IF EXISTS `KEY_CACHES`;
CREATE TABLE IF NOT EXISTS `KEY_CACHES` (
...
--
-- Estrutura stand-in para view `KEY_COLUMN_USAGE`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `OPTIMIZER_TRACE`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `PARAMETERS`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `PARTITIONS`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `PLUGINS`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `PROCESSLIST`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `PROFILING`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `REFERENTIAL_CONSTRAINTS`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `ROUTINES`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `SCHEMATA`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `SCHEMA_PRIVILEGES`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `SESSION_STATUS`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `SESSION_VARIABLES`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `SPATIAL_REF_SYS`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `SQL_FUNCTIONS`
-- (Veja abaixo para a visão atual)
--
DROP VIEW IF EXISTS `SQL_FUNCTIONS`;
CREATE TABLE IF NOT EXISTS `SQL_FUNCTIONS` (
`FUNCTION` varchar(64)
);
...
--
-- Estrutura stand-in para view `STATISTICS`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `SYSTEM_VARIABLES`
-- (Veja abaixo para a visão atual)
--
DROP VIEW IF EXISTS `SYSTEM_VARIABLES`;
...
--
-- Estrutura stand-in para view `TABLES`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `TABLESPACES`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `TABLE_CONSTRAINTS`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `TABLE_PRIVILEGES`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `TABLE_STATISTICS`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `TRIGGERS`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `USER_PRIVILEGES`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `USER_STATISTICS`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `user_variables`
-- (Veja abaixo para a visão atual)
--
DROP VIEW IF EXISTS `user_variables`;
...
--
-- Estrutura stand-in para view `VIEWS`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura para view `ALL_PLUGINS`
--
...
--
-- Estrutura para view `APPLICABLE_ROLES`
--
...
--
-- Estrutura para view `CHARACTER_SETS`
--
...
--
-- Estrutura para view `CHECK_CONSTRAINTS`
--
...
--
-- Estrutura para view `CLIENT_STATISTICS`
--
...
--
-- Estrutura para view `COLLATIONS`
--
...
--
-- Estrutura para view `COLLATION_CHARACTER_SET_APPLICABILITY`
--
...
--
-- Estrutura para view `COLUMN_PRIVILEGES`
--
...
--
-- Estrutura para view `ENABLED_ROLES`
--
...
--
-- Estrutura para view `GEOMETRY_COLUMNS`
--
...
--
-- Estrutura para view `GLOBAL_STATUS`
--
...
--
-- Estrutura para view `GLOBAL_VARIABLES`
--
...
--
-- Estrutura para view `INDEX_STATISTICS`
--
...
--
-- Estrutura para view `INNODB_BUFFER_PAGE`
--
...
--
-- Estrutura para view `INNODB_BUFFER_PAGE_LRU`
--
...
--
-- Estrutura para view `INNODB_BUFFER_POOL_STATS`
--
...
--
-- Estrutura para view `INNODB_CMP`
--
...
--
-- Estrutura para view `INNODB_CMPMEM`
--
...
--
-- Estrutura para view `INNODB_CMPMEM_RESET`
--
...
--
-- Estrutura para view `INNODB_CMP_PER_INDEX`
--
...
--
-- Estrutura para view `INNODB_CMP_PER_INDEX_RESET`
--
...
--
-- Estrutura para view `INNODB_CMP_RESET`
--
...
--
-- Estrutura para view `INNODB_FT_BEING_DELETED`
--
...
--
-- Estrutura para view `INNODB_FT_CONFIG`
--
...
--
-- Estrutura para view `INNODB_FT_DEFAULT_STOPWORD`
--
...
--
-- Estrutura para view `INNODB_FT_DELETED`
--
...
--
-- Estrutura para view `INNODB_FT_INDEX_CACHE`
--
...
--
-- Estrutura para view `INNODB_FT_INDEX_TABLE`
--
...
--
-- Estrutura para view `INNODB_LOCKS`
--
...
--
-- Estrutura para view `INNODB_LOCK_WAITS`
--
...
--
-- Estrutura para view `INNODB_METRICS`
--
...
--
-- Estrutura para view `INNODB_MUTEXES`
--
...
--
-- Estrutura para view `INNODB_SYS_COLUMNS`
--
...
--
-- Estrutura para view `INNODB_SYS_DATAFILES`
--
...
--
-- Estrutura para view `INNODB_SYS_FIELDS`
--
...
--
-- Estrutura para view `INNODB_SYS_FOREIGN`
--
...
--
-- Estrutura para view `INNODB_SYS_FOREIGN_COLS`
--
...
--
-- Estrutura para view `INNODB_SYS_INDEXES`
--
...
--
-- Estrutura para view `INNODB_SYS_SEMAPHORE_WAITS`
--
...
--
-- Estrutura para view `INNODB_SYS_TABLES`
--
...
--
-- Estrutura para view `INNODB_SYS_TABLESPACES`
--
...
--
-- Estrutura para view `INNODB_SYS_TABLESTATS`
--
...
--
-- Estrutura para view `INNODB_SYS_VIRTUAL`
--
...
--
-- Estrutura para view `INNODB_TABLESPACES_ENCRYPTION`
--
...
--
-- Estrutura para view `INNODB_TABLESPACES_SCRUBBING`
--
...
--
-- Estrutura para view `INNODB_TRX`
--
...
--
-- Estrutura para view `KEY_CACHES`
--
...
--
-- Estrutura para view `KEY_COLUMN_USAGE`
--
...
--
-- Estrutura para view `OPTIMIZER_TRACE`
--
...
--
-- Estrutura para view `PARAMETERS`
--
...
--
-- Estrutura para view `PARTITIONS`
--
...
--
-- Estrutura para view `PROCESSLIST`
--
...
--
-- Estrutura para view `REFERENTIAL_CONSTRAINTS`
--
...
--
-- Estrutura para view `SCHEMA_PRIVILEGES`
--
...
--
-- Estrutura para view `SESSION_STATUS`
--
...
--
-- Estrutura para view `SESSION_VARIABLES`
--
...
--
-- Estrutura para view `SPATIAL_REF_SYS`
--
...
--
-- Estrutura para view `SQL_FUNCTIONS`
--
...
--
-- Estrutura para view `STATISTICS`
--
...
--
-- Estrutura para view `SYSTEM_VARIABLES`
--
...
--
-- Estrutura para view `TABLESPACES`
--
...
--
-- Estrutura para view `TABLE_CONSTRAINTS`
--
...
--
-- Estrutura para view `TABLE_PRIVILEGES`
--
...
--
-- Estrutura para view `TABLE_STATISTICS`
--
...
--
-- Estrutura para view `USER_PRIVILEGES`
--
...
--
-- Estrutura para view `USER_STATISTICS`
--
...
--
-- Estrutura para view `user_variables`
--
