...
export default function AnunciantesPage() {
  ...
  async function loadMore() {
    ...
    try {
      ...
      setHasMore(advertisers.length + rows.length < totalCount);
    } catch (e) {
      console.error(e);
