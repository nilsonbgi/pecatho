  ...
  return (
    <main className="min-h-screen bg-slate-50 px-4 py-12">
      <section className="mx-auto max-w-xl rounded-3xl border bg-white p-8 text-center shadow-sm sm:p-10">
        ...
        <h1 className="mt-3 text-3xl font-bold tracking-tight text-slate-950">Pagamento pendente</h1>
        <p className="mx-auto mt-4 max-w-md text-sm leading-6 text-slate-600">O provedor ainda não confirmou o pagamento. Não é necessário realizar uma nova compra agora. Assim que houver confirmação, o acesso será atualizado.</p>
