-- Add deterministic sorting to public advertiser discovery.
...
returns table(id uuid, slug text, title text, display_name text, summary text, city_id bigint, state_id bigint, category_id bigint, verification_status text, pricing jsonb, created_at timestamptz, city_name text, state_uf text)
language sql
security definer
...
revoke all on function public.search_public_advertisers(bigint,bigint,bigint,text,jsonb,text[],integer,integer,numeric,numeric,integer,text,integer,integer) from public;
