...
create or replace function public.start_advertiser_conversation(p_profile_id uuid)
returns uuid
language sql
security invoker
set search_path = public, private
as $$
  select private.start_advertiser_conversation(p_profile_id);
$$;

revoke all on function private.start_advertiser_conversation(uuid) from public, anon, authenticated;
