-- Duration-aware advertiser price search
-- Keeps advertiser pricing period-based and allows public discovery to target
-- a specific duration while preserving the existing price range filters.

drop function if exists public.search_public_advertisers(bigint,bigint,bigint,text,jsonb,text[],integer,integer,numeric,numeric,integer,integer);

create function public.search_public_advertisers(
